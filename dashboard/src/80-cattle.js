  ...
  box.innerHTML=`
    ...
    ${(()=>{ const S=herdSeries(); if(!S) return '';
      ...
      <div class="legend">
        ...
        <span><i style="background:#ff9100"></i>movimiento sin conteo (${S.sinConteo})</span>
        <span style="margin-left:auto">la caída real es mayor</span></div>`;})()}
...
function herdSeries(){
  ...
  return {pts, ciegos, desde, hasta, anchor:{t:t0, n:n0},
