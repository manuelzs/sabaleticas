...
- **Land: 170.73 ha** `[cadastre]` — **two parcels under one matrícula 023-16153**: *AP 1 SABALETITAS* 151.85 ha (La Pintada) + *LO 1 EL GUAICO* 18.88 ha (Santa Bárbara). The farm **straddles a municipal boundary**; always query the cadastre by **matrícula**, never by municipality, or it silently truncates. ✅ The old 193.41 ha discrepancy is **resolved**: the plan included the **playón (21.90 ha)**, the river terrace the cadastre excludes as non-titleable — leaving a 0.78 ha residual. Nothing was missing. **Open question: whether we can *graze* the playón** (~13% more land, matters for verano capacity); legal status unresearched. **Herd:** ~266 head (stale, selling) → **~1.9/ha** on potrero. Never quote a per-hectare figure without saying which area it uses.
...
3b. 🔴 **Water / El Niño — the most urgent operational risk.** `operations/water/README.md`. NOAA gives **>90% odds of a very strong El Niño** and 69% of a *historic* one (Oct–Dec 2026) [S43]; IDEAM projects **10–30% less rain** in the Andean region and **falling quebrada flows** [S44]. **Both our water sources are bocatomas on quebradas** — so two sources, one failure mode; no redundancy against drought. Storage ~70,000 L = **5–7 days of autonomy** for 266 head [S42]. Tanks are full today and some smaller ones are disconnected — connecting them is the cheapest storage available. Act in the ~3 months before Dec–Mar.
