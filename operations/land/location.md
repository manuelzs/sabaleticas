...
- **Coordinates:** 5.7954955° N, −75.6020412° W (this is the **entrance**, on the road —
  not the centre or extent of the property)
- **Google place:** Hacienda Sabaleticas (place ID `0x8e46f15f40522bdb:0x7723af12c260ce7c`)
...
## Boundaries (confirmed by owner)

| Side | Boundary |
|---|---|
| **East** | **Ruta Nacional 25** (Vía La Pintada–Santa Bárbara). The entire farm lies **west of the road**; the entrance fronts it. |
| **West** | the **Río Poblanco**. The farm is on the **east bank**. |
...
Sabaleticas was part of **Hacienda El Guaico**, the original (much larger) ranch, **split
twice** — both times north–south, *not* along the river:

1. **~40 years ago (~1986):** El Guaico split in **two** — the **northern** piece carved off
   (now Sabaleticas's north boundary).
2. **~20 years ago (~2006):** the remaining (southern) El Guaico split in **four** among
   siblings. **Sabaleticas is one of the four parcels** (~200 ha); the parcel that kept the
   name **"El Guaico" is now the southern neighbor**.

Per the owner: the parcels on the **east bank of the Poblanco are family** (the sibling
shares and neighbors on this side); the land **across the river to the west is not family**.
So the river is the western edge and a family/non-family line, but it is **not** one of the
El Guaico split lines — those run north–south.

## Surroundings (read off satellite — confirm against the boundary map)

- **Road access:** the entrance is **directly on Ruta 25** (the Troncal toward Medellín).
  Good for trucking cattle out — worth remembering when we look at selling logistics.
- **Neighbors / landmarks:** north = the ~40-yr-ago carve-off; south = Hacienda El Guaico;
  other family parcels on the east bank (Casa La Esmeralda, etc.). A Tigo tower "Torre Tigo
  Damasco" and "Palenque" sit to the SE for orientation.
- **Terrain (preliminary):** hilly; a mix of open pasture (lighter) and tree/forest cover
