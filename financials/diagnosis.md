...
|---|---|---|---|
| **H1** | **Low turnover** — cattle accumulate instead of cycling through. Costs are monthly; sales are rare. **→ Structurally confirmed** ([`../herd/turnover.md`](../herd/turnover.md)): ~142 hembras at/past finish age (incl. 7 overdue at 3–5 yr) against ~4.5 small-lot guías/month, on adequate stocking (1.33/ha) — a velocity problem, not capacity. | The herd is 256 females, many sitting in the 1–3 yr range, few sales events. Capital and pasture tied up, little revenue. | Count of head **sold per year** (blocked by GSMI head-per-guía gap — see turnover.md); avg days-on-farm per animal. |
